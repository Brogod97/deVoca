...
import static devoca.common.JDBCTemplate.close;
import static devoca.common.JDBCTemplate.commit;
import static devoca.common.JDBCTemplate.getConnection;
import static devoca.common.JDBCTemplate.rollback;
...
public class MemberService {
	...
	/*
	 * 
	 * public int kakaoSignUp(Member m2) throws Exception{ Connection conn =
	 * getConnection();
	 * 
	 ...
	 * 
	 * 
	 * public Member kakaoLogin(Member m3) throws Exception { // Connection 얻어오기
	 * Connection conn = getConnection();
	 * 
	 * // DAO 수행 Member loginMember = dao.kakaoLogin(conn, m3);
	 * 
	 * 
	 * 
	 * // Connection 반환 close(conn);
	 * 
	 * // 결과 반환 return loginMember; }
	 * 
	 * 
	 * 
	 * 
	 * public Member kakaoOne(String id) { // TODO Auto-generated method stub return
	 * null; }
	 * 
	 */
