	...
	public List<Word> selectWordAll(Connection conn, int memberNo, int categoryNo) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				word.setQuizOx(rs.getString("quiz"));
	...
	public List<Word> selectWordFavorite(Connection conn, int memberNo, int categoryNo) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				String quizOx = rs.getString("quiz");
//				String language = rs.getString("LANGUAGE");

				Word word = new Word(wordNo, categoryNo, wordTitle, wordDf, wordMemo, codeBlock, createDate, checked,
						favorite, quizOx);
