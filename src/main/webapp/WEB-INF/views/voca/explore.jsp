...
<html lang="ko">
  <head>
    ...
    />
    <link rel="stylesheet" href="${contextPath}/resources/css/explore.css" />
    ...
    <main>
      ...
      <section class="container">
        ...
        <section class="side-bar">
          ...
          <form action="${contextPath}/voca/quiz-main" method="get">
            <button
              id="quiz-start-btn"
                ...
                <c:forEach var="member" items="${memberList}">
                  <li class="member">
                    <div class="member-thumbnail">
                      <img src="${contextPath}/${ member.profileImage }" />
                    </div>
                    <span class="member-nickname"> ${member.memberNick} </span>
                    <span class="member-number" style="display: none">
                      ${member.memberNo}
                    </span>
                  </li>
                </c:forEach>
